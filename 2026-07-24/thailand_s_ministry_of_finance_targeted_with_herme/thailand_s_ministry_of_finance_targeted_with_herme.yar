...
rule Salamander_Data_Insufficient
{
  meta:
    ...
    malware = "Hades, VShell, ShadowPad - S0596, POISONPLUG.SHADOW, suo5"
  condition:
    hash.md5(0, filesize) == "9c9976adbb1f4cda0e3ba85d3ed9c211" or
    hash.sha1(0, filesize) == "cfa6312db63b91f8c4022078a487c1c86b7e0901" or
    ...
    hash.sha256(0, filesize) == "ec7e9ab43a0cc65d29f0b84a93ba88c43d01fed3dec5c968525dc73c03cbfda2" or
    hash.sha256(0, filesize) == "ff662b60f6a142f99292fbdd65dd1ccd79dc9628686ddf5935c92f7fb1b62a81"
}
