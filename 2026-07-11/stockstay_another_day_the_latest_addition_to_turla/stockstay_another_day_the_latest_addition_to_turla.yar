...
rule Salamander_Turla
{
  meta:
    author = "Salamander CTI"
    reference = "https://salacti.com"
    actor = "Turla"
    malware = "STOCKSTAY, Kazuar - S0265, WILDDAY, DIAMONDBACK, STOCKSTAY.STOCKBROKER, STOCKSTAY.STOCKMARKET, STOCKSTAY.STOCKTRADER, STOCKSTAY.MARKETMAKER"
  condition:
    hash.sha256(0, filesize) == "391e51354118fb87dc57650cbbd94258c3f7c0a0d6868040b7a473ad626ff25e" or
    hash.md5(0, filesize) == "123508dbce0c72623756ccf793eb7183" or
    hash.md5(0, filesize) == "2ee228def4ab5f4f75b978be1f2d474d" or
    hash.md5(0, filesize) == "86a75cdc7c5f2a9cc87bbf56e925e544" or
    hash.md5(0, filesize) == "9f89939b8b3cbf015b85b67974e15ce7" or
    hash.md5(0, filesize) == "ff9f6af06c64a51a576333da5c780263" or
    hash.sha1(0, filesize) == "4ec2ba1fdc083f69a6132afba72c21f456f6d0af" or
    hash.sha1(0, filesize) == "5c96ada9b79fa8bd2feb496a8bd6ac7d17287c99" or
    hash.sha1(0, filesize) == "b5939b7b8925a83d715429aaa2603ae85746d485" or
    hash.sha1(0, filesize) == "c214c62867aae327fbaa4f35dadc786cbe213727" or
    hash.sha1(0, filesize) == "fb3dbf671ff7c72e02ab03837bd9ce72dca799bd" or
    ...
    hash.sha256(0, filesize) == "e6d8192960a89d5480868b94088cccdaa1560f9c8a0b0282ced2b7c1f72341b6"
}
