...
rule Salamander_INC
{
  meta:
    ...
    malware = "INC"
  condition:
    hash.sha256(0, filesize) == "6cd349eda0fa6c8b274a0920852c68f8b727afea1fdbc69ad183cef05d9cf141" or
    hash.md5(0, filesize) == "03dd0efa84d145d7d4ed8e240267e5c5" or
    hash.sha1(0, filesize) == "265a8e89464e32b22553ef16edbab703da7176a7" or
    hash.md5(0, filesize) == "dce9ad6317ce147f1f3f74bc93d9252a" or
    hash.md5(0, filesize) == "eb37c4fcfc00d3813ab94f4d59378b47" or
    hash.sha1(0, filesize) == "16bad42a397db2e075e09b5b9dd53aaa67b495a4" or
    hash.sha1(0, filesize) == "70331fdf528f4f5b75b5e30427e379bc88aa05b4" or
    ...
    hash.sha256(0, filesize) == "ff5da8f0330a4c581c37284c74aae2683c007dc6e406e1e2e6803e7bb398b77b"
}
